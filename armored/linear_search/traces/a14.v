...
Definition a14 : isla_trace :=
  ...
  Smt (DefineConst 27%Z (Binop (Eq) (Val (Val_Symbolic 24%Z) Mk_annot) (Val (Val_Bits (BV 1%N 0x1%Z)) Mk_annot) Mk_annot)) Mk_annot :t:
  tcases [
    ...
    Smt (DefineConst 29%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 28%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x14%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
